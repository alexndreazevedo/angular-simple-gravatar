module.exports = function (grunt) {
  ...
  grunt.registerTask('build', ['clean:build','concat','clean:build_templates']);
  grunt.registerTask('release', ['clean:build','concat','uglify','clean:build_templates','jshint','karma:unit']);
